...
<header id="header">
	<div id="logo-group" style="width:500px">
		...
		<span><a href="/index.cfm"> <img width="45px" height="46px" style= "margin-left:10px"src="/assets/img/pfote_klein.png" alt="ZWLLING">
		</a> </span>
	...
	<div class="pull-right">
		...
		<div id="logout" class=" btn-header transparent pull-right">
			<span> <a href="/index.cfm/logout" title="Sign Out" data-action="userLogout" data-logout-msg="You can improve your security further after logging out by closing this opened browser"><i class="fa fa-sign-out"></i></a> </span>
		</div>
		<!-- end logout button -->
